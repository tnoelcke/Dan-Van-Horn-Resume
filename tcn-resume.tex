    ...
    \resumeSubheading
      ...
      \resumeItemListEnd
		...
		\resumeSubheading
			...
			\resumeItemListStart
				\resumeItem{Office Hours:}{Held office hours where I helped students learn about general programing practices, answered questions about assignments and quizzes.}
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    \item{
     \textbf{Languages}{: \textbf{C#, C++, C, JavaScript, JSON, Java, HTML, CSS, Python} SQL, XML, XAML, Bootstrap, VBA, LaTex, Node JS, Bash}}
     \item{
